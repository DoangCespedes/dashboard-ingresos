          ...
          <GridItem xs={12} md={8}>
            ...
            {error && <div>{error}</div>}
              ...
              <div style={{padding:"5px", width: "100%", background: "#f5f5f5", color: "#000", fontSize: "1.5rem", textAlign: "center", borderRadius: "10px" }}>
                  {montoFaltante ? <TableInfo montoFaltante={montoFaltante} office={office} /> : 'No hay datos '} {/* Manejo del caso en que montoSobrante es undefined */}
                </div>
              </div>
          </GridItem>

          <GridItem xs={12} md={4}>
            <BarChart montoFaltante={montoFaltante} office={office} />
          </GridItem>
        </GridContainer>
      </CardManagement>
    </>
